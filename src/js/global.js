...
function setContentFromHash(){
    ...
    if (currentHash === "About"){
        ...
        for (var id in projects){
            if (projects[id].hash === currentHash){
                loadProject(id); 
                return; 
            }
        }
...
function loadProject(projectId){
    ...
    $( "#right-section" ).load(projects[projectId], function() {
        //Finished 
        /* 
            Set all href of #right-section
                + Previous project
                + Next project 
                + More information (?!)

            Previous project and next project depend on current 
            project id. Thus 
        ...
        */
        ...
        $("#right-section").animate(
            ...
            function() {
               ...
               $("#project-name").html(projects[projectId].name); 
